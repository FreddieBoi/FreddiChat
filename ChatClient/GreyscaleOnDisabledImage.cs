...
namespace FreddiChatClient {
    ...
    public class GreyscaleOnDisabledImage : Image {
        ...
        private static void OnGreyscaleOnDisabledImageIsEnabledPropertyChanged(DependencyObject source, DependencyPropertyChangedEventArgs args) {
            ...
            if (Convert.ToBoolean(args.NewValue)) {
                ...
                // It isn't enabled (false), use greyscale!
